...
// ─── DOCUMENTOS REALES GARNIER (sincronizados con parsedDocuments.json) ──────
// Los IDs deben coincidir con los generados por extract-pdfs.js para que
// el motor RAG de aiService.ts pueda filtrar chunks por documento activo.

export const mockDocuments: Document[] = [
  {
    id: 'rh-00',
    fileName: 'RH-00 Código de Conducta Ética Corporativo v4.pdf',
    originalName: 'RH-00 Código de Conducta Ética Corporativo v4',
    description: 'Código de ética corporativo: valores, conflicto de interés, antisoborno, confidencialidad y procedimiento del Comité de Ética.',
    status: 'active',
    pageCount: 21,
    fileSize: '397.7 KB',
    uploadedAt: '2026-05-21T20:35:25Z',
    uploadedBy: 'Sistema Garnier',
  },
  {
    id: 'rh-02',
    fileName: 'RH-02 Politica Empresa Familiarmente Responsable v5 (1).pdf',
    originalName: 'RH-02 Politica Empresa Familiarmente Responsable v5 (1)',
    description: 'Política de empresa familiarmente responsable: maternidad, paternidad, lactancia, guarderías, horario flexible y licencias especiales.',
    status: 'active',
    pageCount: 16,
    fileSize: '313.2 KB',
    uploadedAt: '2026-05-21T20:35:25Z',
  ...
  {
    id: 'rh-04',
    fileName: 'RH-04 Política contra el Hostigamiento y acoso v7.1 (1).pdf',
    originalName: 'RH-04 Política contra el Hostigamiento y acoso v7.1 (1)',
    description: 'Política de prevención y manejo del hostigamiento sexual y acoso laboral (mobbing) en el lugar de trabajo.',
    status: 'active',
    pageCount: 16,
    fileSize: '343.2 KB',
    uploadedAt: '2026-05-21T20:35:25Z',
  ...
  {
    id: 'rh-12',
    fileName: 'RH-12 Política contra la violencia a las mujeres v4.pdf',
    originalName: 'RH-12 Política contra la violencia a las mujeres v4',
    description: 'Política corporativa de cero tolerancia contra la violencia hacia las mujeres: prevención, detección y atención.',
    status: 'active',
    pageCount: 26,
    fileSize: '544.3 KB',
    uploadedAt: '2026-05-21T20:35:25Z',
  ...
  {
    id: 'rh-13',
    fileName: 'RH-13 Política de teletrabajo v2.1.pdf',
    originalName: 'RH-13 Política de teletrabajo v2.1',
    description: 'Lineamientos para la modalidad de teletrabajo: requisitos, equipamiento, seguridad de información y obligaciones del colaborador.',
    status: 'active',
    pageCount: 18,
    fileSize: '391.3 KB',
    uploadedAt: '2026-05-21T20:35:25Z',
  ...
  {
    id: 'rh-23',
    fileName: 'RH-23 Política de viáticos v3.pdf',
    originalName: 'RH-23 Política de viáticos v3',
    description: 'Política y procedimiento de viáticos: montos autorizados, anticipos, liquidaciones y gastos reembolsables para viajes de trabajo.',
    status: 'active',
    pageCount: 18,
    fileSize: '415.4 KB',
    uploadedAt: '2026-05-21T20:35:25Z',
  ...
  {
    id: 'rh-25',
    fileName: 'RH-25 Código de vestimenta v6.pdf',
    originalName: 'RH-25 Código de vestimenta v6',
    description: 'Código de vestimenta corporativo: lineamientos de presentación personal para oficinas, reuniones y eventos de Garnier.',
    status: 'active',
    pageCount: 14,
    fileSize: '449.6 KB',
    uploadedAt: '2026-05-21T20:35:25Z',
